...
class HelpCommands(commands.Cog):
    ...
    async def help(self, ctx: Context):
        if ctx.author.id in self.blacklisted:
            ...
            embedVar.add_field(
                name="Fun Commands", value=f"{prefix}fhelp", inline=False
            )
            embedVar.add_field(
                name="Staff Commands", value=f"{prefix}shelp", inline=False
            )
            embedVar.add_field(
    ...
    async def ehelp(self, ctx: Context):
        if ctx.author.id in self.blacklisted:
            ...
            embedVar.add_field(
                name=f"{prefix}farm", value="`Farms potatoes`", inline=False
            )
            embedVar.add_field(
